...
const feature = (_a = queryParams.get("feature"), _a !== null && _a !== void 0 ? _a : "normal");
...
screenCanvasElement.addEventListener("dragover", e => {
  e.stopPropagation();
  e.preventDefault();
  if (e.dataTransfer) {
...
screenCanvasElement.addEventListener("drop", e => {
  e.stopPropagation();
  e.preventDefault();
...
vim.readClipboard = (() => {
  var _a;
  return _a = clipboardSupported(), _a !== null && _a !== void 0 ? _a : navigator.clipboard.readText()
});
vim.onWriteClipboard = (text => {
  var _a;
  return _a = clipboardSupported(), _a !== null && _a !== void 0 ? _a : navigator.clipboard.writeText(text)
});
